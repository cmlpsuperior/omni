    ...
    <div class="row">
      <div class="panel panel-primary">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">6. Envío</h3>
        </div>

        <div class="panel-body">
          <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#Total">Total</a></li>
            <li ><a data-toggle="tab" href="#Parcial">Parcial</a></li>
            <li ><a data-toggle="tab" href="#No aplica"></a></li>
          </ul>
            ...
            <div id="Boleta" class="tab-pane fade in active">
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                  ...
                  <input type="number" min="0" class="form-control" id="documentNumber" name="documentNumber" @if ($client->names != null) value="{{$client->documentNumber}}" @endif>
                </div>

                <div class="col-xs-6">         
                  <label for="namesVoucher">Nombre cliente</label>
                  <input type="text" class="form-control" id="namesVoucher" name="namesVoucher" @if ($client->names != null) value="{{$client->fatherLastName.' '.$client->motherLastName.', '.$client->names}}" @endif>
                </div>
              </div>
            ...
            <div id="Factura" class="tab-pane fade">
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                  ...
                  <input type="number" min="0" class="form-control" id="documentNumber" name="documentNumber" required @if ($client->businessName != null) value="{{ $client->documentNumber }}" @endif>
                </div>

                <div class="col-xs-6">         
                  <label for="namesVoucher">Razón social *</label>
                  <input type="text" class="form-control" id="namesVoucher" name="namesVoucher" required @if ($client->businessName != null) value="{{$client->businessName}}" @endif>
                </div>
              </div>
