...
<form role="form" action="{{ action('ZoneController@update', ['id' => $zone->idZone]) }}" method="POST">
...
<div class="row">
  <div class="col-lg-6 col-lg-offset-3">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="name" name="name" type="text" required value="{{ $zone->name }}">
    </div>
    <div class="form-group">
        <label for="shipping">Monto por flete S/ *</label>
        <input class="form-control" id="shipping" name="shipping" type="number" min="0" step="0.01" required value="{{ $zone->shipping }}">
    </div>   
  </div>
</div>
