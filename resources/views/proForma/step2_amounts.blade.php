...
<form role="form" action="{{ action('ProFormaController@amounts_process') }}" method="POST">
<input type="hidden" name="_token" value="{{ csrf_token() }}">

<div class="row">
  <div class="col-lg-6">
    @include('proForma.block1_items')
  </div>
      ...
      <div class="col-xs-6">
        <div class="panel panel-primary">
          ...
          <div class="form-group row text-center">          
            <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Finalizar</button>
          </div>   
